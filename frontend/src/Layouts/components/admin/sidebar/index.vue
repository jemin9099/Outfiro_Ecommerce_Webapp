...
<template>
    <div class="rounded-r bg-black xl:hidden flex justify-between w-full p-6 items-center">
        ...
        <div class="flex justify-between  items-center space-x-3">
            ...
            <p class="text-2xl leading-6 text-white">OutFiro</p>
        </div>
        <div aria-label="toggler" class="flex justify-center items-center">
            <button aria-label="close" id="close" @click="store.toggle()" class=" focus:outline-none focus:ring-2">
    ...
    <div id="Main"
        ...
        <div class="hidden xl:flex justify-start p-6 items-center space-x-3">
            ...
            <p class="text-4xl leading-6 font-semibold text-white">OutFiro</p>
        </div>
        <hr class="w-full">
        <div
            class="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
            <button
                class="flex jusitfy-start items-center space-x-6 w-full  focus:outline-none  focus:text-indigo-400  py-2 text-white rounded ">
